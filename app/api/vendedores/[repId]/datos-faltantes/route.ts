// GET  /api/vendedores/[repId]/datos-faltantes?criteria=sin_email,... → borrador
// POST /api/vendedores/[repId]/datos-faltantes  body {criteria?: string[]} → envía
//
...
export async function GET(req: Request, { params }: { params: { repId: string } }) {
  ...
  const draft = await buildMissingDataDigest(supabase, params.repId, criteria);
